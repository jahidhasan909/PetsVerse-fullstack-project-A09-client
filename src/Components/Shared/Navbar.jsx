            ...
            <nav className=" container mx-auto ">
                <header className="flex h-16 items-center justify-between ">
                    ...
                    <div className="bg-white/20 backdrop-blur-xl gap-7 hidden lg:flex px-17 uppercase rounded-full py-1 border border-white/30">
                        ...
                        <div className="">
                            <Link className={pathname === '/' ? 'py-2 flex items-center  text-[#D97706] gap-1 no-underline font-bold text-[13px]' : 'py-2 no-underline flex items-center text-neutral-400 gap-1 font-semibold text-[13px]'} href={'/'}><span className="mb-0.5"><IconHome size={15} stroke={2} /></span> Home</Link>

                        </div>
                        <div className="">
                            <Link className={pathname === '/allpets' ? 'py-2 text-[#D97706] flex items-center gap-1 no-underline font-bold text-[13px]' : 'py-2 no-underline text-neutral-400 flex items-center gap-1  font-semibold text-[13px]'} href={'/allpets'}><IconList size={15} stroke={2} /> All Pets</Link>
